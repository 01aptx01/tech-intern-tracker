...
export function DashboardHeader({ status, lastCheckedAt, fileModifiedAt, onSync, onAdd }: Props) {
  ...
  return <header className="app-header"><div className="header-inner">
    ...
    <nav className="header-actions" aria-label="เครื่องมือหลัก">
      <SyncIndicator status={status} lastCheckedAt={lastCheckedAt} fileModifiedAt={fileModifiedAt} onSync={onSync} />
