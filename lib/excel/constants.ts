...
export const FULL_COMPANY_NAME_COLUMN = 24;
export const OPEN_PROGRAMS_COLUMN = 25;
export const LAST_DATA_COLUMN = OPEN_PROGRAMS_COLUMN;

export const coreHeaders = [
  'ลำดับ',
  'ชื่อที่รู้จัก',
  'ธุรกิจ',
  'สาย Tech ที่เกี่ยวข้อง',
  'ที่ตั้ง/สถานที่ฝึกในไทย',
  'รูปแบบทำงาน',
  'ข้อมูลติดต่อ HR / บริษัท',
  'ลิงก์สมัคร/อาชีพ',
  'สถานะประกาศ',
  'ช่วงเปิดรับ/Deadline',
  'วันปิดรับ',
  'ช่วงฝึกงาน/สหกิจ',
  'ประเภทโปรแกรม',
  'คุณสมบัติ/หมายเหตุ',
...
export const fieldColumns = {
  ...
  contact: 7,
  applicationUrl: 8,
  announcementStatus: 9,
  applicationWindow: 10,
  applicationDeadline: 11,
  internshipPeriod: 12,
  programTypes: 13,
  openPrograms: 25,
  qualificationsNotes: 14,
  primarySourceUrl: 15,
  secondarySourceUrl: 16,
  verifiedAt: 17,
  evidenceLevel: 18,
  userStatus: 19,
  contactedAt: 20,
